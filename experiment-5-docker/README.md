...
## پرسش ها
# پرسش یک
Dockerfile یک فایل متنی است که شامل دستوراتی برای ساختن یک image است.
Image یک نمونه از پروژه است که شامل تمام وابستگی‌ها و فایل‌های مورد نیاز برای اجرای پروژه می‌باشد.
Container یک نمونه اجرایی از یک image است که به عنوان یک سرویس یا برنامه در حال اجرا است.

# پرسش دو
Kubernetes یک سیستم مدیریت کانتینر است که برای اجرای، مقیاس‌پذیری و مدیریت برنامه‌های کانتینری استفاده می‌شود. Kubernetes به شما این امکان را می‌دهد که چندین کانتینر را در محیط‌های تولیدی مدیریت و توزیع کنید. رابطه آن با داکر این است که Kubernetes می‌تواند کانتینرهای ایجاد شده توسط Docker را مدیریت کند.
