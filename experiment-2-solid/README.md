...
<td>
<p>- استفاده از واسط‌ها برای پرداخت و ثبت سفارش.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>- کلاس‌های OnlineOrderService، OnSiteOrderService و PhoneOrderService می‌توانند جایگزین واسط‌های خود شوند بدون تغییر در رفتار.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>- روش‌های پیاده‌سازی شده در کلاس‌های مختلف ممکن است نیاز به تغییر در کلاس Main داشته باشند.</p>
</td>
</tr>
<tr>
<td rowspan="2">
...
<td>
<p>- همه‌ی روش‌های پرداخت و سفارش در یک واسط کلی OrderService قرار دارند.</p>
</td>
</tr>
<tr>
<td rowspan="2">
...
<td width="284">
<p>استفاده از واسط‌ها برای کاهش وابستگی مستقیم به کلاس‌های پیاده‌سازی خاص و تزریق وابستگی‌ها به کلاس Main.</p>
</td>
</tr>
</tbody>
</table>
